...
public class ArticlesServlet extends HttpServlet {
    ...
    private void showArticles(HttpServletRequest request,
        ...
        // BEGIN
        PagedList<Article> pagedArticles = new QArticle().setFirstRow(offset).setMaxRows(articlesPerPage).orderBy().id.asc().findPagedList();
    ...
    private void showArticle(HttpServletRequest request,
        ...
        Article article = new QArticle()
                .id.equalTo(id)
                .findOne();
//        String category = article.getCategory().getName();
...
//        request.setAttribute("category", category);
    ...
    private void createArticle(HttpServletRequest request,
        ...
        Category category = new QCategory().id.eq(Long.parseLong(categoryId)).findOne();
