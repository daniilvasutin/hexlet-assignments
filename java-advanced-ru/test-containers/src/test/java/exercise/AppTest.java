...
public class AppTest {
    ...
    void getAllPerson() throws Exception {
        ...
        var str = responsePost.getContentAsString();

        assertThat(responsePost.getContentAsString()).contains("John");
    ...
    void deletePerson() throws Exception {
        ...
        assertThat(responseGet.getContentAsString()).doesNotContain("John");
    }
...
//        var str = responseGet.getContentAsString();

        assertThat(responseGet.getContentAsString()).contains("Jackson");
    }
